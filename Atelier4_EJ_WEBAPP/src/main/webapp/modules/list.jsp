    ...
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; }
        body { 
            ...
            background: linear-gradient(135deg, #e8c4d0 0%, #d8b4e8 100%);
            min-height: 100vh;
            padding: 20px;
        }
        .container {
        ...
        <table>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td><span style="background: #f8d7da; padding: 4px 10px; border-radius: 12px; font-size: 0.9em; font-weight: 600; color: #8b4789;"><%= code %></span></td>
                    <td><%= nom %></td>
